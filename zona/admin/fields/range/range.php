			...
			if ( isset( self::$_option['dependency']) && is_array( self::$_option['dependency'] ) ) {
				...
				echo '<div class="box-row-input">';
					...
					echo '<div class="box-tc box-tc-input">';
						...
						echo '<input name="' . esc_attr( self::$_option['id'] ) . '" id="' . esc_attr( self::$_option['id'] ) . '" type="number" value="' . esc_html( self::$_option['std'] ) . '" class="range-input" min="'.esc_attr( self::$_option['min'] ).'" max="'.esc_attr( self::$_option['max'] ).'"/>';

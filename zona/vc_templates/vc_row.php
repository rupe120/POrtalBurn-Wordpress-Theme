...
if ( empty( $full_width ) ) {
	$css_classes[] = 'vc_row_default';
} else if ( 'stretch_row' === $full_width ){
	$css_classes[] = 'vc_row_stretch_row';
} else if ( 'stretch_row_content' === $full_width ){
	$css_classes[] = 'vc_row_full_stretch';
} else if ( 'stretch_row_content_no_spaces' === $full_width ){
	$css_classes[] = 'vc_row_full_stretch_no_spaces';
}
...
if ( 'stretch_row' === $full_width ){
	if ( 'narrow' === $content_width ) {
		$vc_extra_classes = 'narrow';
    } else {
    	$vc_extra_classes = '';
    }
    $output .= '<div class="vc-container ' . $vc_extra_classes . '">';
}
// End custom code ----------------------------------------
